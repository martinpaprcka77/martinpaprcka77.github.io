...
The **Toolkit** module (36 functions, 1.5.0+) is published to [PowerShell Gallery](https://www.powershellgallery.com/packages/Toolkit) to enable one-command installation:
...
git commit -m "Bump Toolkit to v1.5.0"
git tag v1.5.0
