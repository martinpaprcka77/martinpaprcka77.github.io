...
- **Module root**: `toolkit/Toolkit/Toolkit.psd1` — 36 exported functions
- **Tests**: `Invoke-Pester toolkit/tests/Toolkit.Tests.ps1` — 73 test cases
...
- Cross-platform: guard with `$PSVersionTable.PSVersion.Major -ge 6` before `$IsWindows`
