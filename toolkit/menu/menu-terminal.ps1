...
function Show-TerminalTroubleshootingMenu {
    $items = [ordered]@{
        ...
        '5.   Back' = @{ Action = { return }; Desc = 'Return to terminal menu' }
    }
...
function Show-TerminalMenu {
    ...
    $items = [ordered]@{
        ...
        '9.   Troubleshooting' = @{ Action = { Show-TerminalTroubleshootingMenu }; Desc = 'VS Code terminal launch troubleshooting checklist' }
        '10.   Back' = @{ Action = { return }; Desc = 'Return to main menu' }
    }
