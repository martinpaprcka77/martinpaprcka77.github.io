...
function Write-Ok   { param([string]$M) Write-TkMessage -Level Ok   -Message $M; $script:installed++ }
function Write-Skip { param([string]$M) Write-TkMessage -Level Skip -Message $M; $script:skipped++ }
function Write-Fail { param([string]$M) Write-TkMessage -Level Fail -Message $M; $script:failed++ }
