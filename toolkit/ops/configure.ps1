...
.DESCRIPTION
    ...
    - Nastavení editoru
    Výsledek uloží do config/settings.json.
.PARAMETER Reset
...
if ($Reset) {
    if (-not (Confirm-Action "This overwrites config/settings.json with defaults, discarding your current settings. Continue?")) {
